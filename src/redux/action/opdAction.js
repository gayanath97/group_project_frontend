...
import {GetOpdbillApiDetails, PostOpdbillApiDetails,UpdateOpdbillApiDetails,DeleteOpdbillApiDetails } from "../../services/OpdBillService";
const GetOpdbillApiAction = () =>{

    return function(dispatach){
        return GetOpdbillApiDetails()
                  .then((res)=>{
...
const PostOpdbillApiAction = (request) =>{
    ...
    return function(dispatach){
        ...
        return PostOpdbillApiDetails(request)
                  .then((res)=>{
                    console.log('Response Data is _____',res);
                    dispatach({
                        type:POST_OPDBILL_DETAILS,
...
const UpdateOpdbillApiAction = (id,request) =>{
    ...
    return function(dispatach){
        ...
        return  UpdateOpdbillApiDetails(id,request)
                  .then((res)=>{
                    console.log('Response Data is _____',res);
                    dispatach({
                        type:UPDATE_OPDBILL_DETAILS,
...
const DeleteOpdbillApiAction = (id) =>{
    ...
    return function(dispatach){
        ...
        return DeleteOpdbillApiDetails(id)
                  .then((res)=>{
                    console.log('Response Data is _____',res);
                    dispatach({
                        type:DELETE_OPDBILL_DETAILS,
...
export {GetOpdbillApiAction,PostOpdbillApiAction,UpdateOpdbillApiAction,DeleteOpdbillApiAction};